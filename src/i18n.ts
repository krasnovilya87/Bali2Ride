...
const baseEn: Translations = {
  ...
  footer: {
    desc: 'Creating the best riding experience on the Island of Gods. Premium motorcycles for your perfect vacation.',
    nav: 'Navigation',
    services: 'Services',
    contacts: 'Contacts',
...
export const translations: Record<Language, Translations> = {
  ...
  ru: {
    ...
    hero: { subtitle: 'Остров Бали / Приключения ждут', title1: 'Свобода на', title2: 'двух колесах', description: 'Аренда проверенных байков на Бали с доставкой до вашей виллы.', btnCatalog: 'Посмотреть каталог', btnTerms: 'Условия аренды', freeDelivery: 'Бесплатная доставка', deliverySub: 'В любую точку Южного Бали', insurance: 'Полная страховка', insuranceSub: 'Ваше спокойствие приоритет', support: '24/7 Поддержка', supportSub: 'Мы на связи в WhatsApp' },
    catalog: { subtitle: 'Наш автопарк', title1: 'Выберите свой', title2: 'идеальный транспорт', all: 'Все байки', scooters: 'Байки', enduro: 'Эндуро', sport: 'Мотоциклы', cruisers: 'Круизеры', notFoundTitle: 'Не нашли модель?', notFoundDesc: 'Напишите нам в WhatsApp.', whatsappBtn: 'Написать в WhatsApp', perDay: 'дней', dateFrom: 'С', dateTo: 'По' },
    testimonials: { subtitle: 'Отзывы', title: 'Что говорят клиенты' },
    footer: { desc: 'Премиум байки для вашего отпуска.', nav: 'Навигация', services: 'Услуги', contacts: 'Контакты', dayRent: 'Аренда на день', longRent: 'Долгосрочная аренда', delivery: 'Доставка к отелю', gear: 'Экипировка в комплекте' }
  },
  id: {
